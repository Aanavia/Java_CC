/*Vu Ai Van Trinh
 * AVL Trees
 * test program that randomly generates 500,000 numbers 
 * and inserts them into a BST
 * reshuffles the 500,000 numbers and performs a search,
 *  and reshuffle the numbers again before deleting them from the tree.
 *   Do the same thing using an AVL tree
 *   program compare the running times
 */
...
public class CompareRunningTime {
 ...
 public static void main(String[] args) {
  ...
  for (Integer integer : ran) {
   bst.insert(integer);
  }
  System.out.println("BST insertion time = " + (System.currentTimeMillis() - time));
  
  time = System.currentTimeMillis();
  for (Integer integer : ran) {
   AVLTree.insert(integer);
  }
  System.out.println("AVLTree insertion time = " + (System.currentTimeMillis() - time));
 Collections.shuffle(ran);
  ...
  System.out.println("BST search time = " + (System.currentTimeMillis() - time));

  time = System.currentTimeMillis();
  for (Integer integer : ran) {
   AVLTree.search(integer);
  }
  System.out.println("AVLTree search time = " + (System.currentTimeMillis() - time));
