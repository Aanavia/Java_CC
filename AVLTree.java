...
public class AVLTree<E extends Comparable<E>> extends BST<E> {
  ...
  static class AVLTreeextends Comparable> extends BST 
   /** Create a default AVL tree */
   public AVLTree() 
    ...
    */
    ...
    for (int i = path.size() - 1; i >= 0; i--) 
     ...
     {case -2:
      ...
      { balanceLL(A, parentOfA);} // Performing the LeftLeftrotation
       else 
       { balanceLR(A, parentOfA);} // Perform LeftRight rotation
      
      break;
     case +2:
      if (balanceFactor((AVLTreeNode) A.right) >= 0) 
       {balanceRR(A, parentOfA);} // Perform RightRight rotation
       else 
       {balanceRL(A, parentOfA);} // Perform RightLeft rotation
}
